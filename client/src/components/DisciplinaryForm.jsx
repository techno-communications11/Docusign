...
import "./Styles/DisciplinaryForm.css";
...
const DisciplinaryForm = ({ letterheadImgSrc, companyName }) => {
  ...
  const handlePrint = async () => {
    try {
      if (!letterheadImgSrc) {
        alert("Letterhead image not provided.");
        return;
      }
      ...
      const warningWidths = WARNING_TYPES.map(
        (type) => ctx.measureText(type).width + 30
      );
      ...
      ctx.beginPath();
      ctx.moveTo(
        tableX + headerColWidth,
        outerTableY + rowHeights.heading
      );
      ctx.lineTo(
        tableX + headerColWidth,
        outerTableY + rowHeights.heading + 2 * rowHeights.header
      );
      ctx.stroke();
      ...
      ctx.moveTo(
        ...
        outerTableY + outerTableHeight - 2 * rowHeights.signature[1]
      );
      ctx.lineTo(
        tableX + signatureColWidth,
        outerTableY + outerTableHeight
      );
      ctx.stroke();
      ...
      wrapText(
        ...
        tableX + headerPadding,
        contentY + 15,
        headerColWidth - 2 * headerPadding,
        15
      );
      wrapText(
      ...
      wrapText(
        `DATE: ${formData.date || ""}`,
        tableX + headerColWidth + headerPadding,
        contentY + 15,
        headerColWidth - 2 * headerPadding,
        15
      );
      ...
      ctx.fillText(
        "COMPANY STATEMENT",
        tableX + companyStatementWidth / 2,
        contentY + 15
      );
      ctx.fillText(
        "Nature of Violation",
        tableX + companyStatementWidth + maxViolationWidth / 2,
        contentY + 15
      );
      ...
      ctx.textAlign = "left";
      wrapText(
        formData.companyStatement || "",
        tableX + 10,
        contentY + 15,
        companyStatementWidth - 20,
        15
      );
      ...
      VIOLATIONS.forEach((violation) => {
        ...
        if (
          violation === "Others (If Any):" &&
          formData.violation.includes(violation) &&
          formData.otherViolationText
        ) {
          displayText += ` ${formData.otherViolationText}`;
        }
        wrapText(
          displayText,
          tableX + companyStatementWidth + 10,
          contentY + 15,
          maxViolationWidth - 20,
          15
        );
        contentY += rowHeights.violation;
      });
      ...
      wrapText(
        employeeStatementText,
        tableX + employeeStatementMargin,
        contentY + 15,
        tableWidth - 2 * employeeStatementMargin,
        15
      );
      contentY += rowHeights.employee[1];

      wrapText(
        `I DISAGREE with company’s description of violation: ${
          formData.disagree || ""
        }`,
        tableX + employeeStatementMargin,
        contentY + 15,
      ...
      ctx.fillText(
        "EMPLOYEE SIGNATURE:",
        tableX + signatureColWidth / 4,
        contentY + 20
      );
      ctx.fillText(
        "SUPERVISOR SIGNATURE:",
        tableX + signatureColWidth + signatureColWidth / 4 + 10,
        contentY + 20
      );
      ...
      ctx.fillText(
        "DATE:",
        tableX + signatureColWidth / 10,
        contentY + 15
      );
      ctx.fillText(
        "DATE:",
        tableX + signatureColWidth + signatureColWidth / 10,
        contentY + 15
      );
  ...
  const isOtherViolationSelected =
    formData.violation.includes("Others (If Any):");
    ...
    >
      ...
      <Form>
        ...
        <Form.Group className="mb-2">
          ...
          <div
            className="row"
            style={{ maxHeight: "60mm", overflowY: "auto" }}
          >
